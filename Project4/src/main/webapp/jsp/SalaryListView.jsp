...
<body>
	...
	<div align="center">
		...
		<form action="<%=ORSView.SALARY_LIST_CTL%>" method="POST">
			...
			List<SalaryBean> statuslist = (List<SalaryBean>) request.getAttribute("statusList");
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>Salary Status : </b></label> <%=HTMLUtility.getList("status", String.valueOf(bean.getStatus()), statuslist)%>&emsp;
						<label><b>Employee Name :</b></label> <input type="text" name="employeeName"
						placeholder="Enter Employee name"
						value="<%=ServletUtility.getParameter("employeeName", request)%>">&emsp;
