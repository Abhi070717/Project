			...
			<table>
				...
				<tr>
					...
					<td align="left" colspan="2"><input type="submit"
						name="operation" value="<%=AccountCtl.OP_UPDATE%>"> <input
						type="submit" name="operation" value="<%=AccountCtl.OP_CANCEL%>">
						<%
						} else {
						%>
					<td align="left" colspan="2"><input type="submit"
						name="operation" value="<%=AccountCtl.OP_SAVE%>"> <input
						type="submit" name="operation" value="<%=AccountCtl.OP_RESET%>">
						<%
						}
						%>
				</tr>
