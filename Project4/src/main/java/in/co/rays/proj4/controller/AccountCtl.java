...
@WebServlet(name = "AccountCtl", urlPatterns = { "/AccountCtl" })
...
public class AccountCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("code"))) {
			request.setAttribute("code", PropertyReader.getValue("error.require", "Account Code"));
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("type"))) {
			request.setAttribute("type", PropertyReader.getValue("error.require", "Account Type"));
			pass = false;
		}
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setAccountType(DataUtility.getString(request.getParameter("type")));
